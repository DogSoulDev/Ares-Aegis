...
class EmoticonosMitologicos:
    ...
    ARES = "⚔️"              # Dios de la guerra - Escaneador/Combate
    ATHENA = "🛡️"           # Diosa de la sabiduría - Protección/FIM
    HERMES = "🚀"            # Mensajero - Monitoreo de red/Comunicaciones  
    HADES = "🔥"             # Dios del inframundo - Cuarentena
    APOLLO = "☀️"            # Dios de la luz - Reportes/Análisis
    ZEUS = "⚡"              # Rey de dioses - Sistema principal
    
    # Criaturas mitológicas
    ARGOS = "👁️"             # Gigante de 100 ojos - Monitoreo
    HYDRA = "🐲"             # Hidra - Amenazas múltiples
    PHOENIX = "🔥"           # Fénix - Recuperación/Restauración
    CERBERUS = "🐕"          # Guardián del Hades - Firewall
    
    # Elementos épicos
    ESCUDO = "🛡️"           # Protección general
    ESPADA = "⚔️"           # Ataque/Escaneo activo
    CORONA = "👑"           # Estado premium/Activo
    RAYO = "⚡"             # Poder/Energía
    FUEGO = "🔥"            # Destrucción/Cuarentena
    CRISTAL = "💎"          # Datos valiosos/Métricas
    PERGAMINO = "📜"        # Reportes/Logs
    FORTALEZA = "🏛️"       # Arquitectura del sistema
    BALANZA = "⚖️"         # Análisis/Evaluación
    OJO = "👁️"             # Vigilancia/Monitoreo
    RELOJ = "⏰"            # Tiempo real
    CORAZON = "❤️"          # Estado de salud del sistema
