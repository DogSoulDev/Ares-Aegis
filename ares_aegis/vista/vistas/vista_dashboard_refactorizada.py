...
from ..componentes_ui.terminal_integrado import TerminalIntegrado
from ..componentes_ui.sistema_ayuda import SistemaAyuda


class VistaDashboard(VistaBase):
        ...
        try:
            ...
            if os.path.exists(imagen_path):
                ...
                if width_original > max_width:
                    factor = max_width / width_original
                    new_width = int(width_original * factor)
                    new_height = int(height_original * factor)
                    self.imagen_principal = self.imagen_principal.subsample(int(1/factor))
