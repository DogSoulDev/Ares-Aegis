...
class AnalizadorForenseCuarentena:
    ...
    def _cargar_patrones_analisis(self) -> Dict[str, Union[List[str], List[bytes]]]:
        ...
        return {
            'strings_sospechosos': [
                ...
                'CreateObject', 'WScript.Shell', 'cmd.exe', 'powershell',
    ...
    def _cargar_firmas_conocidas(self) -> Dict[str, str]:
        ...
        return {
            ...
            'a1b2c3d4e5f6789012345678901234567890abcd': 'Win32.Backdoor',
        ...
        try:
            ...
            if resultado.returncode == 0:
                ...
                for string in strings_encontrados:
                    ...
                    comandos_sospechosos = ['cmd.exe', 'powershell', 'bash', 'sh', '/bin/', 'system(']
